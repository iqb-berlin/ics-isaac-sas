...
RESPONSEVALUE_ANY_OF_SCHEMAS = ["List[bool]", "List[float]", "List[str]", "bool", "float", "str"]
...
class ResponseValue(BaseModel):
    ...
    # data type: List[bool]
    anyof_schema_3_validator: Optional[List[StrictBool]] = None
    # data type: float
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[bool], List[float], List[str], bool, float, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: List[str] = Literal[RESPONSEVALUE_ANY_OF_SCHEMAS]
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ResponseValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ResponseValue with anyOf schemas: List[bool], List[float], List[str], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ResponseValue with anyOf schemas: List[bool], List[float], List[str], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
